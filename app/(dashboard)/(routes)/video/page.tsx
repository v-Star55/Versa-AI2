...
const Conversation = () => {
        ...
        try {
            const completion = await openai.chat.completions.create({
                messages: [
                    {
                        role: "system",
                        content: "You are a helpful assistant designed to output JSON. The JSON fields are: 'question' : 'asked by the user', 'answer' : 'response from the ai model'",
                    },
    ...
    return (
        <div>
            <MainHeading
                title="Conversations"
                description="Conversations are the heart of any communication. Explore the power of AI to generate conversations."
                icon={MessageSquare}
